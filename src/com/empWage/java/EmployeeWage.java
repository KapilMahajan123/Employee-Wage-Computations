...
public class EmployeeWage {
		...
		public int calculateWage() {
			...
			while (totalWorkingHours <= workingHours && days <= workingDays) {
				...
				/*
				 * By using switch case for empCheck
				 * Calculating of salary and total working hours
				 */
				switch (empCheck) {
				case 1:
			...
			return totalWorkingHours * WagePerHour;  //return

		}
		//main method
		public static void main(String[] args) { 
			/*
			 * it create employeeWage object and add to company names 
			 * print the total employee wage company
			 */
